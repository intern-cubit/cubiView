                ...
                >
                    ...
                    <div className="border-t border-gray-700/50 p-6 lg:p-8">
                        <div className="flex flex-col sm:flex-row justify-end gap-3">
                            ...
                            <button className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-6 py-3 rounded-lg transition-all duration-300 flex items-center justify-center hover:shadow-lg hover:shadow-green-500/20">
