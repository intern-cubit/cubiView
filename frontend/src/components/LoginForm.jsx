                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    >
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                >
                                    {showPassword ? (
                                        <EyeOff size={18} className={isDark ? 'text-gray-400 hover:text-gray-300' : 'text-gray-500 hover:text-gray-600'} />
                                    ) : (
                                        <Eye size={18} className={isDark ? 'text-gray-400 hover:text-gray-300' : 'text-gray-500 hover:text-gray-600'} />
                                    )}
                                </button>
                            </div>
                        </div>
                    ...
                    >
                        <Button
                            ...
                            icon={!isLoading ? <LogIn size={18} /> : null}
                        >
